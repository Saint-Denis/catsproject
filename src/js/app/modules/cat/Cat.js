...
import removeFromFavourite from "../../actions/removeFromFavourite";
...
class Cat extends Component {
    ...
    getCatsId = () => {
        const { randomCatId, selectedBreedId, isFavourite } = this.props
    ...
    handleToggleFavourite = () => {
        ...
        if (!this.state.isFavourite) {
            addToFavourite(catImage, this.getCatsId(), !this.state.isFavourite);
        } else {
            removeFromFavourite(this.getCatsId());
        }
    }
...
const mapDispatchToProps = (dispatch) => {
    return {
      addToFavourite: (catImage, id, isFavourite) => dispatch(addToFavourite(catImage, id, isFavourite )),
